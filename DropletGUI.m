...
if (isempty(datafit) == 0)
    ...
    Z1 = datafit.z1;
    Z2 = datafit.z2;
    a_raw = data(NVideo).area{Ndrop};
    min_raw = data(NVideo).minax{Ndrop};
    maj_raw = data(NVideo).minax{Ndrop};
    X_raw = data(NVideo).X{Ndrop};
    time = data(NVideo).XX{Ndrop};
    h = msgbox('Processing');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'a'},'Sheet1','A1:A1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],a','Sheet1','A2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'min'},'Sheet1','B1:B1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],min','Sheet1','B2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'maj'},'Sheet1','C1:C1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],maj','Sheet1','C2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'X'},'Sheet1','D1:D1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],X','Sheet1','D2');    
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'z1'},'Sheet1','E1:E1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],Z1','Sheet1','E2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'z2'},'Sheet1','F1:F1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],Z2','Sheet1','F2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'min_raw'},'Sheet1','G1:G1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],min_raw','Sheet1','G2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'maj_raw'},'Sheet1','H1:H1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],maj_raw','Sheet1','H2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'X_raw'},'Sheet1','I1:I1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],X_raw','Sheet1','I2');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],{'time'},'Sheet1','J1:J1');
    xlswrite([address,['Data(',FileName{NVideo},'Tracked).xls']],time','Sheet1','J2');
    close(h);
